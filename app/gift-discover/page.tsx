...
export default function GiftDiscover() {
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      {current ? (
        <div className="flex-1 flex items-center justify-center p-8 overflow-hidden">
          <div className="w-full max-w-6xl h-full flex items-center gap-8">
            ...
            <button
              onClick={() => act('dislike')}
              className="group flex-shrink-0 w-32 h-32 rounded-3xl bg-gradient-to-br from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 shadow-2xl hover:shadow-red-500/50 transition-all duration-300 transform hover:scale-110 active:scale-95 flex flex-col items-center justify-center text-white"
              aria-label="Dislike"
            >
            ...
            <div className="flex-shrink-0 flex flex-col gap-4">
              ...
              <button
                ...
                className="group w-32 h-32 rounded-3xl bg-gradient-to-br from-amber-400 to-orange-500 hover:from-amber-500 hover:to-orange-600 shadow-2xl hover:shadow-amber-500/50 transition-all duration-300 transform hover:scale-110 active:scale-95 flex flex-col items-center justify-center text-white"
              ...
              <button
                onClick={() => act('like')}
                className="group w-32 h-32 rounded-3xl bg-gradient-to-br from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 shadow-2xl hover:shadow-emerald-500/50 transition-all duration-300 transform hover:scale-110 active:scale-95 flex flex-col items-center justify-center text-white"
                aria-label="Like"
              >
                <svg className="w-12 h-12 mb-2" fill="currentColor" viewBox="0 0 24 24">
      ...
      {/* Shortcut helper removed per request */}
    </div>
  );
}